...
<body>
    <div class="container">
        ...
        <form id="productoForm" action="<?php echo $edicion ? 'http://localhost/tecweb/practicas/p08/update_producto.php' : 'http://localhost/tecweb/practicas/p08/set_producto_v2.php'; ?>" method="POST" enctype="multipart/form-data">
